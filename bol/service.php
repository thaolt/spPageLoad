...
class SPPAGELOAD_BOL_Service
{
    ...
    public function requireSpPageLoadJs() {
    	OW::getDocument()->addScript(SPPAGELOAD_BOL_Service::getPlugin()->getStaticUrl() . 'js/base64.js?b'.self::BUILD_NUMBER);
    	OW::getDocument()->addScript(SPPAGELOAD_BOL_Service::getPlugin()->getStaticUrl() . 'js/jquery.pjax.js?b'.self::BUILD_NUMBER);
    	OW::getDocument()->addScript(SPPAGELOAD_BOL_Service::getPlugin()->getStaticUrl() . 'js/sppageload.js?b'.self::BUILD_NUMBER);
